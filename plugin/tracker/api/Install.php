...
class Install
{
     ...
     * 数据库连接
     */
    protected static string $connection = 'plugin.admin.mysql';
    ...
    public static function update($from_version, $to_version, $context = null): void
    {
        ...
        // 执行更新操作
        $update_file = dirname(__DIR__) . '/update.php';
    ...
    {
        static::importSql(dirname(__DIR__) . '/install.sql');
    }
     ...
     * @return void
     */
    public static function importSql($mysqlDumpFile): void
    {
